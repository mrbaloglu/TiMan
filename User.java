...
public class User {
    ...
    /**
	 * Method checks if username is taken before or not.
     * @param userList
     * @param username 
	...
	/**
	 * Prints info to username.txt file.
	 * @throws IOException
	 */
